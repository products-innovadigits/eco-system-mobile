...
import 'package:pms_system/features/projects_progress/bloc/projects_progress_cubit.dart';
import 'package:pms_system/features/projects_progress/bloc/projects_progress_state.dart';
import 'package:pms_system/features/projects_progress/widgets/project_progress_mobile_landscape.dart';
import 'package:pms_system/features/projects_progress/widgets/project_progress_mobile_portrait.dart';
...
class ProjectProgressSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ProjectsProgressCubit()..loadProjectsProgress(),
