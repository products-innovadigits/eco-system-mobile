...
import 'package:pms_system/features/latest_request/widgets/latest_request_app_bar_widget.dart';
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider<LatestRequestSortingCubit>(
          create: (context) => LatestRequestSortingCubit(),
        ),
        BlocProvider<LatestRequestFiltrationCubit>(
          create: (context) => LatestRequestFiltrationCubit(),
        ),
