...
class ProjectDetailsBloc
  ...
  _onLoadProjectDetails(
    ...
    try {
      ...
      Response res = await ProjectDetailsRepo.getProjectDetails(event.projectId);
  ...
  _onLoadProjectTimeline(
    ...
    try {
      ...
      Response res = await ProjectDetailsRepo.projectTimeline(event.projectId);
      ...
      if (res.statusCode == 200 && res.data != null) {
        ...
        emit(
          const ProjectTimelineFailure(message: 'Failed to load timeline'),
        );
      }
    } catch (e) {
      emit(
  ...
  Future<void> _onSelectTab(
    ...
    if (_cachedModel != null) {
      ...
      emit(
        const ProjectDetailsFailure(message: 'No cached project details'),
      );
    }
  }
}
