...
/// Initial state
class ProjectGeneralProgressSummaryInitial extends ProjectGeneralProgressSummaryState {
  const ProjectGeneralProgressSummaryInitial();
}

/// Loading progress summary
class ProjectGeneralProgressSummaryLoading extends ProjectGeneralProgressSummaryState {
  const ProjectGeneralProgressSummaryLoading();
}

/// Progress summary loaded successfully
class ProjectGeneralProgressSummaryLoaded extends ProjectGeneralProgressSummaryState {
...
class ProjectGeneralProgressSummaryFailure extends ProjectGeneralProgressSummaryState {
