...
**Checkpoint M0**: Stop if T009 does not record G-M0 as passed. M1 documentation and asset cleanup may continue, but no M2+ on-device pipeline implementation starts or merges.
